...
` + h[x].replace(' at new ', ' at ');
  ...
  function ye(r) {
    ...
    if (typeof r == 'object')
      switch (r.$$typeof) {
        ...
        case Ae:
          return (
            (i = r.displayName || null), i !== null ? i : ye(r.type) || 'Memo'
          );
        case be:
  ...
  function Rv(r, i, a, f, h) {
    switch (i) {
      ...
      case 'gotpointercapture':
        return (
          (m = h.pointerId), Ws.set(m, Ks(Ws.get(m) || null, r, i, a, f, h)), !0
        );
    }
    return !1;
  }
          ...
          for (var N = P, j; N !== null; ) {
            ...
            if (
              (j.tag === 5 &&
                ...
                ((j = Q),
                L !== null &&
                  ((Q = Bs(N, L)), Q != null && ne.push(ii(N, Q, j)))),
              Be)
            )
              break;
            N = N.return;
...
`
  ...
  function nh(r) {
    ...
    function W(L, N, j) {
      ...
      if (typeof N == 'object' && N !== null) {
        ...
        if (An(N) || se(N))
          return (N = vr(N, L.mode, j, null)), (N.return = L), N;
        Io(L, N);
      }
      return null;
    }
        ...
        switch (j.$$typeof) {
          case F:
            e: {
              ...
              j.type === q
                ? ((N = vr(j.props.children, L.mode, Q, j.key)),
                  (N.return = L),
                  (L = N))
                : ((Q = el(j.type, j.key, j.props, null, L.mode, Q)),
                  (Q.ref = ai(L, N, j)),
  ...
  function _h(r, i, a) {
    return (
      (a = a != null ? a.concat([r]) : null), Fo(4, 4, xh.bind(null, i, r), a)
    );
  }
  function _c() {}
  function Eh(r, i) {
...
` +
  ...
  function qw(r, i, a, f, h, m, x) {
    ...
    if (h.data === '$!') {
      ...
      return (
        (f = b), (m = Error(n(419))), (f = bc(m, f, void 0)), Ho(r, i, x, f)
      );
    }
      ...
      case 5:
        ...
        if (f & 4 && ((h = r.stateNode), h != null)) {
          ...
          if (((r.updateQueue = null), T !== null))
            try {
              b === 'input' && m.type === 'radio' && m.name != null && Qi(h, m),
                pa(b, x);
              var P = pa(b, m);
  ...
  function el(r, i, a, f, h, m) {
    ...
    if (((f = r), typeof r == 'function')) Gc(r) && (x = 1);
      ...
      e: switch (r) {
        ...
        case M:
          return (
            (r = Ft(12, a, i, h | 2)), (r.elementType = M), (r.lanes = m), r
          );
        case X:
    ...
    return (
      (i = Ft(x, a, i, h)), (i.elementType = r), (i.type = f), (i.lanes = m), i
    );
  }
  function vr(r, i, a, f) {
...
function br(t, e) {
  ...
  function g(E) {
    let C = l();
    for (C !== E && c('parsing quoted string'); !s && o() !== E; )
      o() === '\\' && l(), (C += l());
      ...
      R.useEffect(() => {
        (async () => {
          ...
          if (
            ...
            return;
          (M = (B = C.current) == null ? void 0 : B.cm) == null ||
...
class my {
  ...
  expectHitTarget(e, n) {
    ...
    for (; l && l !== n; )
      c.push(l),
        u.push(
          ['sticky', 'fixed'].includes(this.window.getComputedStyle(l).position)
        ),
        (l = lt(l));
    if (l === n) return 'done';
    ...
    for (; y; ) {
      const v = c.indexOf(y);
      if (v !== -1) {
        v > 1 && (g = this.previewNode(c[v - 1])),
          (p = u.slice(0, v).some(S => S));
        break;
      }
      y = lt(y);
    }
    return g
      ? {
          hitTargetDescription: `${d} from ${g} subtree`,
          hasPositionStickyOrFixed: p,
        }
...
` &&
    ...
    return (
      yield Ui, yield* this.pushToIndex(e + 1, !0), yield* this.parseLineStart()
    );
  }
  *parsePlainScalar() {
...
function sk(t, e = {}) {
  ...
  if (s && n)
    for (const u of c) u.errors.forEach(Vl(t, n)), u.warnings.forEach(Vl(t, n));
...
function fv(t, e = {}) {
  ...
  return (
    s && n && (c.errors.forEach(Vl(t, n)), c.warnings.forEach(Vl(t, n))), c
  );
}
function ik(t, e, n) {
  let s;
