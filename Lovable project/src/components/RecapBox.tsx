...
export default function RecapBox({ activeStep }: { activeStep: string }) {
  const stepRecaps = {
    input: {
      ...
      description: "Hai completato la validazione dei dati. I tuoi dataset sono ora pronti per l'analisi professionale.",
      tips: "Tip: Dataset puliti = risultati affidabili. Hai fatto il primo passo fondamentale!"
    },
    storica: {
      title: "Analisi Storica Completata!",
      description: "Hai esplorato le performance storiche e identificato i trend principali dei tuoi titoli.",
      tips: "Tip: Le performance passate informano ma non garantiscono risultati futuri."
    },
    performance: {
      title: "Metriche di Performance Calcolate!",
      description: "Hai calcolato Sharpe Ratio, CAGR e altre metriche chiave per valutare la qualità dei rendimenti.",
      tips: "Tip: Un Sharpe Ratio > 1 indica buona performance risk-adjusted."
    },
    rischio: {
      title: "Profilo di Rischio Definito!",
      description: "Hai quantificato volatilità, VaR e drawdown per comprendere i rischi del portafoglio.",
      tips: "Tip: Diversificazione intelligente riduce il rischio senza sacrificare rendimento."
    },
    fondamentale: {
      title: "Analisi Fondamentale Conclusa!",
      description: "Hai valutato multipli, redditività e qualità dei bilanci per una visione completa.",
      tips: "Tip: Combina sempre analisi tecnica e fondamentale per decisioni migliori."
    },
    ottimizzazione: {
      title: "Portafoglio Ottimizzato!",
      description: "Hai costruito la frontiera efficiente e trovato l'allocazione ottimale del capitale.",
      tips: "Tip: Riequilibra periodicamente per mantenere l'ottimizzazione nel tempo."
    },
    strategie: {
      title: "Strategie Testate!",
      description: "Hai eseguito backtest completi e valutato la validità delle strategie quantitative.",
      tips: "Tip: Attenzione all'overfitting - valida sempre out-of-sample."
    },
    output: {
      title: "Report Professionale Generato!",
      description: "Hai completato l'analisi completa e generato un report professionale esportabile.",
      tips: "Tip: Documenta sempre metodologie e assunzioni per trasparenza."
    }
  };

  const currentRecap = stepRecaps[activeStep as keyof typeof stepRecaps] || stepRecaps.input;
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 space-y-3">
          <div className="flex items-center gap-3">
            <h3 className="font-bold text-xl text-yellow-800">{currentRecap.title}</h3>
