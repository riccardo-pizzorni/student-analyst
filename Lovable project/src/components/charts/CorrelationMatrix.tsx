...
export default function CorrelationMatrix() {
  const correlationData = [
    { symbol: 'AAPL', values: [1.0, 0.67, 0.45, 0.32, 0.28] },
    { symbol: 'MSFT', values: [0.67, 1.0, 0.72, 0.41, 0.35] },
    { symbol: 'GOOGL', values: [0.45, 0.72, 1.0, 0.38, 0.29] },
    { symbol: 'AMZN', values: [0.32, 0.41, 0.38, 1.0, 0.44] },
    { symbol: 'TSLA', values: [0.28, 0.35, 0.29, 0.44, 1.0] },
  ];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-orange-200">
              Rilevate correlazioni elevate tra MSFT e GOOGL (0.72)
            </p>
          </div>
        </div>
      </div>
