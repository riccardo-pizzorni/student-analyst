...
import LocalStorageCacheL2, {
  localStorageCacheL2,
} from '../../src/services/LocalStorageCacheL2';
    ...
    it('should handle complex nested objects', () => {
      const complexObj = {
        ...
        data: {
          ...
          price: 150.25,
          volume: 1000000,
          historical: [{ open: 149.0, high: 151.0, low: 148.5, close: 150.25 }],
        },
      };
  ...
  describe('Internal Methods and Edge Cases', () => {
    ...
    it('should handle storage key prefixing', () => {
      ...
      const storageKeys = Object.keys(
        (mockStorage as { store: Record<string, string> }).store
      );
      expect(storageKeys.some(key => key.includes('student-analyst-l2'))).toBe(
        true
      );
    });
