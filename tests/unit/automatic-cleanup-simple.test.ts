...
describe('AutomaticCleanupService - Comprehensive Tests', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should have correct default configuration', () => {
      ...
      expect(config.lruThresholds.L1).toBe(0.90);
    ...
    it('should initialize successfully', async () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith('🧹 Inizializzazione AutomaticCleanupService...');
      expect(consoleSpy.log).toHaveBeenCalledWith('✅ AutomaticCleanupService inizializzato con successo');
    });
  ...
  describe('Service Shutdown', () => {
    it('should shutdown gracefully', () => {
      ...
      expect(global.clearTimeout).toHaveBeenCalled();
      expect(consoleSpy.log).toHaveBeenCalledWith('🧹 AutomaticCleanupService arrestato');
    });
