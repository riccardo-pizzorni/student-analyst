...
jest.mock('react-csv', () => ({
    CSVLink: ({ data, filename }: any) => (
        <a href="#" data-testid="csv-download" data-filename={filename} data-rows={data?.length}>
            Download CSV
        </a>
    ),
}));
...
describe('HistoricalTable', () => {
    ...
    describe('Rendering States', () => {
        ...
        it('should render no data state correctly', () => {
            ...
            expect(screen.getByText(/Avvia un'analisi per visualizzare i dati storici/)).toBeInTheDocument();
        });
    ...
    describe('Export Functionality', () => {
        it('should render export button', () => {
            ...
            expect(screen.getByTestId('csv-download')).toHaveAttribute('data-filename', 'dati-storici.csv');
        });
        ...
        it('should show export success message', async () => {
            ...
            expect(mockToast.description).toHaveBeenCalledWith('I dati storici sono stati esportati con successo');
        });
    });
    ...
    describe('User Interactions', () => {
        ...
        it('should handle info button click', async () => {
            ...
            expect(mockToast.title).toHaveBeenCalledWith('Informazioni sulla tabella');
            expect(mockToast.description).toContain('Questa tabella mostra i dati storici OHLCV');
        });
    ...
    describe('Accessibility', () => {
        it('should have proper ARIA labels', () => {
            ...
            expect(screen.getByRole('button', { name: /pulisci filtri/i })).toBeInTheDocument();
        });
