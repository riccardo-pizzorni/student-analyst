import { NotificationManager, notificationManager } from '../../src/services/NotificationManager';
...
describe('NotificationManager', () => {
  ...
  describe('Data Source Notifications', () => {
    it('should show successful data source notification', () => {
      ...
      expect(mockCustomEvent).toHaveBeenCalledWith('show-notification', {
        detail: {
          type: 'success',
          message: '📈 Data from Alpha Vantage: AAPL data retrieved successfully',
          duration: 4000
        }
      });
    });
    ...
    it('should show successful data source notification with fallback', () => {
      ...
      expect(mockCustomEvent).toHaveBeenCalledWith('show-notification', {
        detail: {
          type: 'success',
          message: '📈 Data from Alpha Vantage (backup): AAPL data retrieved successfully using backup provider',
          duration: 4000
        }
      });
    });
  ...
  describe('Provider Switch Notifications', () => {
    it('should show provider switch notification', () => {
      ...
      expect(mockCustomEvent).toHaveBeenCalledWith('show-notification', {
        detail: {
          type: 'warning',
          message: '🔄 Switched to Yahoo Finance: Alpha Vantage is experiencing issues. Automatically using Yahoo Finance for reliable data.',
          duration: 7000
        }
      });
    });
    ...
    it('should handle different provider switch scenarios', () => {
      ...
      expect(mockCustomEvent).toHaveBeenCalledWith('show-notification', {
        detail: {
          type: 'warning',
          message: '🔄 Switched to IEX Cloud: Yahoo Finance rate limit exceeded. Automatically using IEX Cloud for reliable data.',
          duration: 7000
        }
      });
    });
  ...
  describe('Edge Cases and Validation', () => {
    ...
    it('should handle special characters in messages', () => {
      const specialMessage = 'Message with 🚀 emojis & special chars: <>[]{}|\\';
  ...
  describe('Integration with Complex Scenarios', () => {
    it('should handle realistic data fetching scenario', () => {
      ...
      manager.showProviderSwitchNotification('Alpha Vantage', 'Yahoo Finance', 'rate limited');
